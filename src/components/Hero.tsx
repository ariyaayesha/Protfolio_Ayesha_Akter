      ...
      <div className="text-center max-w-4xl">
        ...
        >
          <h1 className="text-6xl md:text-8xl font-bold mb-4">
            {"AYESHA AKTER".split("").map((letter, index) => (
              <motion.span
                key={index}
        ...
        <motion.div
          ...
          className="space-y-4"
        >
          <div className="text-lg text-gray-400"> Fresh Graduate</div>
          <div className="text-blue-400"> Computer Science & Engineering Graduate | 
Building Intelligent Systems • Python • NLP • Deep Learning</div>
        </motion.div>
      </div>
    </section>
  );
