      ...
      <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {[
                  { icon: Mail, label: "ariyaayesha8@gmail.com", href: "mailto:ariyaayesha8@gmail.com", color: "from-red-400 to-pink-400" },
                  { icon: Phone, label: "+8801307783006", href: "tel:+8801307783006", color: "from-green-400 to-blue-400" },
                  { icon: Github, label: "GitHub Profile", href: "https://github.com/ariyaayesha", color: "from-gray-400 to-gray-600" },
                  { icon: Linkedin, label: "LinkedIn Profile", href: "https://www.linkedin.com/in/ayesha-akter-02072002diu", color: "from-blue-400 to-blue-600" }
                ].map((social, index) => (
                  <motion.a
                    key={social.label}
                    href={social.href}
        ...
        >
          <p className="text-gray-500">
            © 2026 Ayesha Akter. Engineering the future with AI.
          </p>
        </motion.div>
      </div>
    </section>
